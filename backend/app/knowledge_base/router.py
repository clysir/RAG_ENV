...
from backend.app.knowledge_base.service import (create_kb, delete_kb,
                                                get_kb_detail, list_kb,
                                                update_kb)
from backend.app.v1.auth.service import get_current_user
from backend.db.my_sql.connect import get_db
from backend.models.user import User
from backend.schemas.knowledge import (KnowledgeBaseCreate,
                                       KnowledgeBaseUpdate,
...
@kb_router.delete(
    "/{kb_id}",
    description="删除知识库接口, 会删除知识库下的所有文件,当前版本无法去解决 文件 和 MinIO之间的关联问题",
)
